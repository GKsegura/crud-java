...
public class Crud {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      System.out.println("==========================================");
      System.out.println(
        "Quantidade de roupas cadastradas: " + listaligada.size()
      );
  ...
  public static int CriaID() {
    if (listaligada.isEmpty()) return 1;
  ...
  public static void Procurar() {
    ...
    /*
    Fazer uma arraylist só com os encontrados, falar quantos foram encontrados e se não encontrar nenhum, dar mensagem
    perguntar se deseja fazer uma nova pesquisa
    mostrar System.out.println("Registro\tID\tModelo\tMarca\tTamanho\tPreco"); somente se achar pelo menos um
     */
